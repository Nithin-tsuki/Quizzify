...
//     // Here, you can add API request to register the user if backend is connected
...
//     navigate('/home'); // or /login if you want them to log in next
//   };
...
//           <div id="fullname" className='s'> {/* New field for full name */}
