...
//     if (!messageId) return;
//     try {
//       await axios.delete(`http://localhost:5001/chat/messages/${messageId}`);
...
//           return (
//             <div
//               key={messageId || ${msg.senderId}-${index}}
//               className={cm-message-wrapper ${isReceived ? "cm-received" : "cm-sent"}}
//             >
//               <div
//                 className={cm-message-bubble ${isReceived ? "cm-received-bubble" : "cm-sent-bubble"}}
//               >
//                 <div className="cm-message-content">
//                   {isReceived && <FaUser className="cm-user-icon" />}
//                   <span>{msg.text}</span>
//                 </div>

//                 <button
//                   onClick={() => handleDelete(messageId)}
//                   className={cm-delete-button ${isReceived ? "cm-delete-left" : "cm-delete-right"}}
//                 >
//                   <FaTrash />
//                 </button>
//               </div>
...
const ChatMessages = ({ messages, selectedFriend, onDeleteMessage }) => {
  ...
  return (
    <div className="cm-chat-container">
      <div className="cm-message-wrapper-container">
        {messages
          .sort((a, b) => new Date(a.createdAt) - new Date(b.createdAt))
          .map((msg, index) => {
            const messageId = msg._id || msg.id;
            const senderId = typeof msg.senderId === "object" ? msg.senderId._id : msg.senderId;
            const isReceived = selectedFriend && senderId === selectedFriend._id;
